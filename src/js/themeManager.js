...
const ThemeManager = {
  ...
  getCategoryIcon(category, theme) {
    ...
    const icons = {
      ...
      pets: `<svg viewBox="0 0 32 32" width="24"><circle cx="16" cy="18" r="8" fill="${color}" opacity="0.15"/><circle cx="16" cy="17" r="6" fill="${color}" opacity="0.2" stroke="${color}" stroke-width="1.2"/><path d="M11 12 L9 6 L14 10Z" fill="${color}" opacity="0.4"/><path d="M21 12 L23 6 L18 10Z" fill="${color}" opacity="0.4"/><circle cx="13.5" cy="15.5" r="1.2" fill="${color}" opacity="0.6"/><circle cx="18.5" cy="15.5" r="1.2" fill="${color}" opacity="0.6"/><ellipse cx="16" cy="18" rx="1.5" ry="1" fill="${color}" opacity="0.5"/><path d="M14.5 19.5 Q16 21 17.5 19.5" stroke="${color}" fill="none" stroke-width="0.8" opacity="0.5"/></svg>`,
